...
$_['entry_shipping_label'] = 'Shipping method label';
$_['entry_shipping_group'] = 'Shipping group label';


$_['entry_cost_increase_mode'] = 'Delivery total cost calculation mode';
$_['entry_cost_increase_mode_max'] = 'Choose max from base cost and increase value';
$_['entry_cost_increase_mode_min'] = 'Choose min from base cost and increase value';
$_['entry_cost_increase_mode_min_nonzero'] = 'Choose min non-zero from base cost and increase value';
$_['entry_cost_increase_mode_sum'] = 'Sum base cost and increase value';
$_['entry_cost_increase_mode_nonzero_increase'] = 'Use only increase value if greater than 0';
